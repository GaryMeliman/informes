    ...
    resize: function (e, i) {
      ...
      h = function (e, s) {
        t(e).each(function () {
          ...
          a = s && s.length ? s : e.parents(i.originalElement[0]).length ? [
            'width',
            'height'
          ] : [
            'width',
...
function (t) {
  ...
  t.widget('ui.sortable', t.ui.mouse, {
    ...
    _getItemsAsjQuery: function (e) {
      ...
      o && o !== this && !o.options.disabled && r.push([t.isFunction(o.options.items) ? o.options.items.call(o.element)  : t(o.options.items, o.element).not('.ui-sortable-helper').not('.ui-sortable-placeholder'),
      o]);
...
}, t.effects && (t.effects.effect[i] || t.effects[i]) ? r.dpDiv.hide(i, t.datepicker._get(r, 'showOptions'), s, n)  : r.dpDiv['slideDown' === i ? 'slideUp' : 'fadeIn' === i ? 'fadeOut' : 'hide'](i ? s : null, n), i || n(), this._datepickerShowing = !1, o = this._get(r, 'onClose'), o && o.apply(r.input ? r.input[0] : null, [
r.input ? r.input.val()  : '',
r
...
break;
case '!':
h = new Date((k('!') - this._ticksTo1970) / 10000),
m = h.getFullYear(),
v = h.getMonth() + 1,
_ = h.getDate();
break;
...
for (P += '<tr>', W = u ? '<td class=\'ui-datepicker-week-col\'>' + this._get(t, 'calculateWeek') (E) + '</td>' : '', w = 0; 7 > w; w++) O = m ? m.apply(t.input ? t.input[0] : null, [
  E
])  : [
  !0,
  ''
...
i[0],
i[1]
], 1 === s.length && (s[1] = s[0]), t.each(['left',
'top'], function (t, e) {
...
a.css(a.from),
('content' === g || 'both' === g) && (u = u.concat(['marginTop',
'marginBottom']).concat(c), d = d.concat(['marginLeft',
'marginRight']), l = r.concat(u).concat(d), a.find('*[width]').each(function () {
var i = t(this),
s = {
height: i.height(),
width: i.width(),
...
s = t.isArray(s) ? t.merge([i], s).sort()  : [
i
]
}
this._setupDisabled(s)
