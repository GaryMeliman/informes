...
//echo dirname(__FILE__).'/../../../conexion/conexion.php';

require_once(dirname(__FILE__).'/../../../conexion/conexion.php');
require_once(dirname(__FILE__).'/../../_filtros/encriptacion/inc_encriptacion.php');
...
$rut	= xps_valida_rut($_GET['rut']);
$login	= xps_desencriptar($_GET['login']);
$pwd	= xps_desencriptar($_GET['pws']);
...
$procedimiento = "call validacion_sistema('$rut','$login','$pwd',0,'0.0.0.0')";
...
//_____________________________________________________________________________			
 ...
 $var_m1 .= '
	...
	header("LOCATION:administrar_menu.php"); 
