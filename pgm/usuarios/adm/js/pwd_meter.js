...
function chkPass(pwd) {
	...
	var sComplexity = "Demasiado corta";
	var sStandards = "Below";
	var nMinPwdLen = 8;//minimo de caracteres
	...
	/* Modify overall score value based on usage vs requirements */
		...
		else if (nScore >= 40 && nScore < 60) { sComplexity = "Bueno"; }
...
function initPwdChk(restart) {
	...
	if (restart) {
		document.getElementById("passwordPwd").className = "hide";
		document.getElementById("passwordTxt").className = "";
