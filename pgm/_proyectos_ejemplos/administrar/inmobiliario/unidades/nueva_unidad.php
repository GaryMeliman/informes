	...
	<!-- *********** INICIO ************ -->
		<div class="col-md-8"><?php //<-- MODIFICABLE, para ver distribucion entrar en http://saturn.pinsupreme.com/grid.html?>
			<div class="widget widget-blue" style="height:500px">
	          <?php
	            $xps_titulo   	="Nueva Unidad en Proyecto <b>".xps_desencriptar($_GET['n'])."</b>";//<-- MODIFICABLE         
              ...
              <div class="col-md-6">
                <div class="form-group has-iconed">
                  ...
                  <div class="iconed-input">
					<input name="TxtTipologia" type="text" id="TxtTipologia" size="40" class="form-control" minlength="2" required placeholder="Nombre">
                  </div>
                </div>
              </div>
			...
			<div class="row">
                ...
                <div class="form-group has-iconed">
                  ...
                  <div class="iconed-input">
	                  	<select name="HdIdUnidadTipo" id="HdIdUnidadTipo" class="form-control">
							<?=crea_cbo('unidades_tipos','id_unidad_tipo','nombre_tipo','id_unidad_tipo','','',0)?>
				  		</select>
                  </div>
                </div>
              </div>			  
              <div class="col-md-4">
                <div class="form-group has-iconed">
                  <label>Mts2</label>
                  <div class="iconed-input">
	                  	<input name="INTMetros2" type="text" id="INTMetros2" size="40" class="form-control" minlength="2" required placeholder="Mts2">
                  </div>
                </div>
              </div> 
				<div class="col-md-4">
