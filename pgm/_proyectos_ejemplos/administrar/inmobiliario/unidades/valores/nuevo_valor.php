	...
	<!-- *********** INICIO ************ -->
		<div class="col-md-8"><?php //<-- MODIFICABLE, para ver distribucion entrar en http://saturn.pinsupreme.com/grid.html?>
			<div class="widget widget-blue" style="height:500px">
	          <?php
	            $xps_titulo   	="Nuevo VALOR Unidad en Proyecto <b>".xps_desencriptar($_GET['n'])."</b>";//<-- MODIFICABLE         
	            $xps_volver   	="grid_valores.php?cl=".$_GET['cl']."&pro=".$_GET['pro']."&n=".$_GET['n']."&pi=".$_GET['pi']."&u=".$_GET['u'];
              ...
              <div class="col-md-6">
                <div class="form-group has-iconed">
                  ...
                  <div class="iconed-input">
					<input name="INTValor" type="text" id="INTValor" size="40" class="form-control" minlength="2" required placeholder="valor">
                  </div>
                </div>
              </div>
