                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="text-right">
                                  ...
                                  <button data-toggle="tooltip" data-original-title="Editar" type="button" class="btn btn-action btn-xs btn-<?=$comentarios?>" id="create-modal1" <?php if(($rsd['id_entrega']<5)){?> onclick="my_modal('Comentarios','1','<?=xps_encriptar($rsd['id_doc_proyecto'])?>','<?=$_GET['pro']?>','<?=xps_encriptar($rsd['id_etapa'])?>','<?=xps_encriptar($rsd['id_documento'])?>','<?=xps_encriptar($rsd['id_entrega'])?>','<?=$rsd['nombre_doc']?>')"<?php }?>><i class="fa fa-folder-open"></i></button>
				...
				<div class="col-md-12">
					<div class="card-content">
                    	...
                    	<div class="form-group text-center">
                			<button type="button" class="btn btn-action btn-xs btn-info" id="submit2" onclick="my_guardar(2)">
                          		<i class="fa fa-external-link-square"> Cambiar estado</i>
                        	</button>
                    	</div>
					</div>
				</div>
...
<?php //============ VENTANA MODAL 3 ==================?>
<!--/// MODAL 3 ------------------------ ARCHIVO ----------------------- -->
<div id="dialog-form3" title="Título" style="display: none; overflow-x: hidden;">
...
$( function() {
 ...
 //MODAL 1___________________________________________
    ...
    $("#UploadMedia"+x +" #insert"+x).append("<input type='hidden' name='param' id='param' value='"+(x==1 ? 0 : 1)+"'>");
		$("#UploadMedia"+x +" #nomArchivo"+x).append(nombre_doc);


		if(x==1){
		    $.ajax({
		    	url: "guardar_upload/ver_comentarios.php",
				type: "POST",
